...
def calculate_fraction(input_csv, output_csv):
    ...
    for index, row in df.iterrows():
        try:
            dipole_moment = row.iloc[7]
            rotational_constant_1 = row.iloc[10]
            rotational_constant_2 = row.iloc[11]
            rotational_constant_3 = row.iloc[12]
...
input_csv = "molecule_filter_TOC/no_symmetry_restriction/csv_files/filter4_prolate_and_linear.csv"
output_csv = "molecule_filter_TOC/no_symmetry_restriction/csv_files/filter4_prolate_and_linear_with_fraction.csv"
